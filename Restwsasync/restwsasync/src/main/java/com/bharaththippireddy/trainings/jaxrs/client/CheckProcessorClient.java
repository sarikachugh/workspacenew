...
public class CheckProcessorClient {
	...
	public static void main(String[] args) {
		...
		WebTarget target = client.target("http://localhost:8091/restwsasync/services/checkservice/checks");
	...
	//(Entity.entity(new ChecksList(), MediaType.APPLICATION_ATOM_XML),Boolean.class);
