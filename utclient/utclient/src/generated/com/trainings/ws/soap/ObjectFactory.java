 ...
 * generated in the com.trainings.ws.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessPaymentResponse_QNAME = new QName("http://soap.ws.trainings.com/", "processPaymentResponse");
    private final static QName _ProcessPayment_QNAME = new QName("http://soap.ws.trainings.com/", "processPayment");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.trainings.ws.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ws.trainings.com/", name = "processPaymentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ws.trainings.com/", name = "processPayment")
